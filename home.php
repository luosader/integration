...
$subject = 
        ...
        '资源:source/common/lib,常用类库;source/common/js,常用JS;#,网站模板'
    ;
$search = array('{p}','{w}','{o}','{m}','{e}','{pl}','{pm}','{s}','{eb}','{ef}');
$replace = array('payment/','withdraw/','oauth/','news/msg/','news/email/','plugin/','plugin/media/','standard/','ext/backend/','ext/frontend/');
