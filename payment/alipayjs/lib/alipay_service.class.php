...
class AlipayService {
     ...
     * @return 表单提交HTML信息
     */
	function create_direct_pay_by_user($para_temp, $button_name, $refresh=true) {
        if ($refresh) echo '请等待跳转……';
		//设置按钮名称
		// $button_name = "确认";
		//生成表单提交HTML文本信息
		$alipaySubmit = new AlipaySubmit();
		$html_text = $alipaySubmit->buildForm($para_temp, $this->alipay_gateway_new, "get", $button_name,$this->aliapy_config, $refresh);
