...
// echo ROOT_URL;// http://www.shihuahuijs.com/include/weixin/
// echo "<br>";
// echo ROOT_PATH;// /yjdata/www/www/baom/
// echo "<br>";
// echo 'http://'.$_SERVER['HTTP_HOST'];// http://www.shihuahuijs.com
// die;
...
if ($get_brand_wcpay_request=='ok' || $check_order) {
    $uid = 1;
    if (!$uid) {
    ...
    $show_url = 'orderlist.php';
} elseif ($get_brand_wcpay_request=='bad' || !$check_order) {
    $show_url = 'index.php';
}
